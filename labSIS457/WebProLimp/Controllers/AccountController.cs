...
namespace WebProLimp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(LabProLimpContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string? returnUrl = null)
        {
            ...
            var empleado = _context.Empleado
                .Where(x => x.Estado == 1 && x.Usuario == model.usuario &&
            ...
            if (empleado != null)
            {
                ...
                var claims = new List<Claim>
                {
                    ...
                    new Claim("FullName", $"{empleado.Nombres} {empleado.PrimerApellido} {empleado.SegundoApellido}"),
