...
public partial class LabProLimpEntities : DbContext
{
    ...
    public virtual int paCompraListar(string parametro)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("paCompraListar", parametroParameter);
    }


    public virtual int paDetalleCompraListar(string parametro)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("paDetalleCompraListar", parametroParameter);
    }
    ...
    public virtual ObjectResult<paProductoListar_Result> paProductoListas(string parametro)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<paProductoListar_Result>("paProductoListas", parametroParameter);
    }
